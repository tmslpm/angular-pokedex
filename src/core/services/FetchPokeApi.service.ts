...
import { NamedAPIResourceList, Pokedex, PokedexParsed, PokemonData, PokemonSpecies, PokemonSpeciesParsed } from "@/core/types/TypePokeApi";
import { asyncFetchJSON, fetchJSON } from "@/core/base/Fetch";
